...
def diff_eqs(INP,t):  
    ...
    Y[0] = birth * (V[0] + V[2]) * 0.99 - beta * V[0] * V[1] - dead * V[0] + p * V[1] * (V[0] + V[2])
    Y[1] = beta * V[0] * V[1] * (0.99 * 0.09) - kill * V[1] * (V[0] + V[2]) - p * V[1] * (V[0] + V[2])
    Y[2] = birth * (V[0] + V[2]) * 0.01 - dead * V[2]
    Y[3] = beta * V[0] * V[1] *(0.99 * 0.90) + dead * V[0] + dead * V[2]
